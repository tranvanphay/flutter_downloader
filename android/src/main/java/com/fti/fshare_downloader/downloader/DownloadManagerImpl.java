...
import com.fti.fshare_downloader.downloader.core.DownloadResponse;
import com.fti.fshare_downloader.downloader.core.DownloadResponseImpl;
import com.fti.fshare_downloader.downloader.core.DownloadTaskImpl;
import com.fti.fshare_downloader.downloader.core.DownloadTaskImpl.DownloadTaskListener;
import com.fti.fshare_downloader.downloader.core.task.DownloadTask;
import com.fti.fshare_downloader.downloader.db.DefaultDownloadDBController;
...
public final class DownloadManagerImpl implements DownloadManager, DownloadTaskListener {
    ...
    public void removeAll() {
        cacheDownloadTask.clear();
        downloadingCaches.clear();
        downloadDBController.deleteAll();
    }
