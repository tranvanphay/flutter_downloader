package com.fti.fshare_downloader.downloader.domain;

import android.text.TextUtils;

import androidx.annotation.IntDef;

import com.fti.fshare_downloader.downloader.callback.DownloadListener;
    ...
    public static final class Builder {
        ...
        public DownloadInfo build() {
            ...
            if (TextUtils.isEmpty(fileName)) {
                throw new DownloadException(DownloadException.EXCEPTION_FILE_NAME, "fileName cannot be null.");
            }
