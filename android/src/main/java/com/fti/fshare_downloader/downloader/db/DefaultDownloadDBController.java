...
public final class DefaultDownloadDBController implements DownloadDBController {
    ...
    public static final String SQL_UPDATE_DOWNLOAD_INFO = String.format(
            "REPLACE INTO %s (_id,supportRanges,createAt,uri,path,fileName,size,progress,status) VALUES(?,?,?,?,?,?,?,?,?);",
    ...
    private void inflateDownloadInfo(Cursor cursor, DownloadInfo downloadInfo) {
        ...
        downloadInfo.setFileName(cursor.getString(5));
    ...
    public void createOrUpdate(DownloadInfo downloadInfo) {
        writableDatabase.execSQL(
                ...
                new Object[]{
                        ...
                        downloadInfo.getCreateAt(), downloadInfo.getUri(), downloadInfo.getPath(),downloadInfo.getFileName(),
    ...
    public void deleteAll() {
        writableDatabase.execSQL("delete from "+ DefaultDownloadHelper.TABLE_NAME_DOWNLOAD_INFO);
        writableDatabase.execSQL("delete from "+ DefaultDownloadHelper.TABLE_NAME_DOWNLOAD_THREAD_INFO);
